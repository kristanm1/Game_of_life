...
y = [52.2958, 107.4802, 235.2993, 514.6665]';
f = @(x) -2.2250e+01 + 6.6583e-05 * x;
plot(x, y, 'co');
plot(t, f(t), 'c');
...
%---v:100, s:100, st_iteracij:(100, 200, 400, 800) :: ---OCL
y = [48.9604, 120.1990, 268.1602, 595.9971]';
f = @(x)   -3.5806e+01 + 7.8436e-05 * x;
plot(x, y, 'co');
plot(t, f(t), 'c');
...
%---v:100, s:100, st_iteracij:(100, 200, 400, 800) :: ---OCL
y = [48.0284, 95.4965, 191.6596, 382.3598]';
f = @(x)      2.0167e-01 + 4.7783e-05 * x;
plot(x, y, 'co');
plot(t, f(t), 'c');
